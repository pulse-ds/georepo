...
| Cities (34) | City council districts | done (official city GIS / AGL) |
...
Current totals: **375 GeoJSON files, 2.2 GB** — all WGS84, all validated
(see `CATALOG.csv`). Local-level coverage is a growing pilot: 34 city
